...
class StarWebPrintTrader {
	constructor(a) { this.papertype = this.checkedblock = this.url = null; this.timeout = 9E4; this.onTimeout = this.onError = this.onReceive = null; void 0 != a && (void 0 != a.url && (this.url = a.url), void 0 != a.checkedblock && (this.checkedblock = a.checkedblock), void 0 != a.papertype && (this.papertype = a.papertype), void 0 != a.timeout && (this.timeout = a.timeout)); }
	sendMessage(a) {
		var b = "<root";
	...
	isCoverOpen(a) { return parseInt(a.traderStatus.substr(4, 2), 16) & 32 ? !0 : !1; }
	isOffLine(a) { return parseInt(a.traderStatus.substr(4, 2), 16) & 8 ? !0 : !1; }
	isCompulsionSwitchClose(a) { return parseInt(a.traderStatus.substr(4, 2), 16) & 4 ? !0 : !1; }
	isEtbCommandExecute(a) { return parseInt(a.traderStatus.substr(4, 2), 16) & 2 ? !0 : !1; }
	isHighTemperatureStop(a) { return parseInt(a.traderStatus.substr(6, 2), 16) & 64 ? !0 : !1; }
	isNonRecoverableError(a) { return parseInt(a.traderStatus.substr(6, 2), 16) & 32 ? !0 : !1; }
	isAutoCutterError(a) { return parseInt(a.traderStatus.substr(6, 2), 16) & 8 ? !0 : !1; }
	isBlackMarkError(a) { return parseInt(a.traderStatus.substr(8, 2), 16) & 8 ? !0 : !1; }
	isPaperEnd(a) { return parseInt(a.traderStatus.substr(10, 2), 16) & 8 ? !0 : !1; }
	isPaperNearEnd(a) { return parseInt(a.traderStatus.substr(10, 2), 16) & 4 ? !0 : !1; }
	extractionEtbCounter(a) { var b = 0; parseInt(a.traderStatus.substr(14, 2), 16) & 64 && (b |= 16); parseInt(a.traderStatus.substr(14, 2), 16) & 32 && (b |= 8); parseInt(a.traderStatus.substr(14, 2), 16) & 8 && (b |= 4); parseInt(a.traderStatus.substr(14, 2), 16) & 4 && (b |= 2); parseInt(a.traderStatus.substr(14, 2), 16) & 2 && (b |= 1); return b; }
