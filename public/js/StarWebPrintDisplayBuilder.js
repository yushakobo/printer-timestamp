...
class StarWebPrintDisplayBuilder {
	...
	createReturnElement(a) { var b = "<return"; void 0 != a && (b += this._analysisEnumAttribute("type", a.type, /^(lf|cr|crlf)$/)); return b + "/>"; }
	...
	createTextElement(a) {
		...
		if (void 0 != a)
			void 0 != a.codepage && (b += this._analysisEnumAttribute("codepage", a.codepage, /^(katakana|cp(437|850|852|858|860|863|865|866|1252)|shift_jis|gb2312|big5|korea)$/)), void 0 != a.international && (b += this._analysisEnumAttribute("international", a.international, /^(usa|france|germany|uk|denmark|sweden|italy|spain|japan|norway|denmark2|spain2|latin_america|korea)$/)), void 0 != a.data ? (b += ">", b = !0 == a.binary ? b + this._encodeEscapeSequenceBinary(a.data) :
				b + this._encodeEscapeSequence(a.data), b += "</text>") : b += "/>";
		else
			throw Error("Argument is undefined.");
		return b;
	}
	createClearScreenElement(a) { var b = "<clear"; void 0 != a && (b += this._analysisEnumAttribute("type", a.type, /^(all|delete_to_end_of_line)$/)); return b + "/>"; }
	createCursorElement(a) { var b = "<cursor"; void 0 != a && (void 0 != a.position && (b += this._analysisEnumAttribute("position", a.position, /^(home|specified)$/), "specified" == a.position && (b += this._analysisValueAttribute("x", a.x, 0, 65535), b += this._analysisValueAttribute("y", a.y, 0, 65535))), void 0 != a.mode && (b += this._analysisEnumAttribute("mode", a.mode, /^(off|on|blink)$/))); return b + "/>"; }
	createToneElement(a) { var b = "<tone"; void 0 != a && (void 0 != a.contrast && (b += this._analysisEnumAttribute("contrast", a.contrast, /^(minus3|minus2|minus1|default|plus1|plus2|plus3)$/)), void 0 != a.brightness && (b += this._analysisEnumAttribute("brightness", a.brightness, /^(minus3|minus2|minus1|default)$/))); return b + "/>"; }
	createTurnOnElement(a) { var b = "<turnon"; void 0 != a && (b += this._analysisEnumAttribute("type", a.type, /^(true|false)$/)); return b + "/>"; }
	...
	if (void 0 != a) {
		...
		throw Error("Argument is undefined."); return a + "</rawdata>";
	}
	...
	_encodeEscapeSequence(a) { var b = /[\\\x00-\x20\x26\x3c\x3e\x7f]/g; b.test(a) && (a = a.replace(b, function (a) { return "\\" == a ? "\\\\" : "\\x" + ("0" + a.charCodeAt(0).toString(16)).slice(-2); })); return a; }
	_encodeEscapeSequenceBinary(a) { var b = /[\\\x00-\x20\x26\x3c\x3e\x7f-\xff]/g; b.test(a) && (a = a.replace(b, function (a) { return "\\" == a ? "\\\\" : "\\x" + ("0" + a.charCodeAt(0).toString(16)).slice(-2); })); return a; }
	...
	_encodeRasterImage(a, b, d) {
		for (var e = [[-254, -126, -222, -94, -246, -118, -214, -86], [-62, -190, -30, -158, -54, -182, -22, -150], [-206, -78, -238, -110, -198, -70, -230, -102], [-14, -142, -46, -174, -6, -134, -38, -166], [-242, -114, -210, -82, -250, -122, -218, -90], [-50, -178, -18, -146, -58, -186, -26, -154], [-194, -66, -226, -98, -202, -74, -234, -106], [-2, -130, -34, -162, -10, -138, -42, -170]], c = "", f = 0, g = 0; g < d; g++) {
			for (var h = 0, k = 128, l = 0; l < b; l++)
				if (((30 * a[f] + 59 * a[f + 1] + 11 * a[f + 2]) * a[f + 3] + 12800) / 25500 - a[f +
					3] < e[g & 7][l & 7] && (h |= k), f += 4, 0 == (k >>= 1))
		...
		a += "\x00\x00";
		for (g = 0; g < b; g += 3)
			d = a.charCodeAt(g) << 16 | a.charCodeAt(g + 1) << 8 | a.charCodeAt(g + 2), c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d >> 18 & 63) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d >> 12 & 63) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d >> 6 & 63) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d &
				63);
		switch (b % 3) {
