...
class StarWebPrintExtManager {
    ...
    _polling() {
        this.isReleaseRequest ? (this.isReleaseRequest = !1, this._sendExtMessage({ requestType: "release", isNeedExternalCallBack: !0 }), this._clearClaimId()) : this._sendExtMessage({ requestType: "read", isNeedExternalCallBack: !1 });
    }
    _analyzeXml(a, d) {
    ...
    _sendExtMessage(a) {
        ...
        d += ">";
        "write" == a.requestType && void 0 != a.request && (d += a.request);
